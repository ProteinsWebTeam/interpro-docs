...
AlphaFold protein structure predictions are generated by `DeepMind <https://deepmind.com/>`_ [:ref:`1 <ref_1>`]. 
...
pages may also display information in the following additional tabs: :ref:`signature`, :ref:`trRosetta`, :ref:`alignment` and :ref:`curation`. 
...
created for some of the Pfam families that do not have a structure in the PDB. They are available under the **trRosetta** 
tab of Pfam signature pages. The models are generated using the automated trRosetta modeling pipeline [:ref:`2 <ref_2>`, :ref:`3 <ref_3>`] developed by the 
...
For each structural model we used DeepAccNet [:ref:`4 <ref_4>`] to estimate its quality in terms of Local Distance Difference Test 
(lDDT) score [:ref:`5 <ref_5>`].
...
of the 3D structure. Clicking on a residue in the viewer induces a zoom in effect and displays contacts with surrounding residues, 
